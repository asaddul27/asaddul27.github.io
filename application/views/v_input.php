...
<body>
  ...
  <div class="container">
    <form action="<?php echo base_url() . 'suratdispensasi/tambah_aksi'; ?>" method="post">
      <table class="table table-striped table-hover">
        ...
        <td>Tanggal Izin</td>
        <td>:</td>
        <td><input type="text" name="tanggalizin" size="30" required></td>
        </tr>
        <td>Alasan</td>
        <td>:</td>
        <td><input type="text" name="alasan" size="30" required></td>
        </tr>
        <td>Tanggal Surat</td>
        <td>:</td>
        <td><input type="text" name="tanggalsurat" size="30" required></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td></td>
